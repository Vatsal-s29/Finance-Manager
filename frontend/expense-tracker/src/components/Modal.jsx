...
const Modal = ({ children, isOpen, onClose, title }) => {
    ...
    return (
        <div className="fixed top-0 right-0 left-0 bottom-0 z-50 flex justify-center items-center w-full h-full max-h-full overflow-y-auto overflow-x-hidden bg-black/40 dark:bg-black/30">
            <div className="relative p-4 w-full max-w-fit max-h-full">
                <div className="relative bg-white rounded-lg shadow-sm min-w-[32rem] max-w-[95vw]">
                    {/* Modal Header */}
                    ...
                    {/* Modal Body */}
                    <div className="p-4 md:p-5 space-y-4 text-gray-700">
                        {children}
                    </div>
                </div>
            </div>
